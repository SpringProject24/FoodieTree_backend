...
<head>
  ...
  /assets/css/common.css">
    ...
    <link rel="stylesheet" href="
  /assets/css/product/main.css">
    <link rel="stylesheet" href="
  /assets/css/product/modal.css">
    <link rel="stylesheet" href="
  /assets/css/product/like-btn.css">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
                ...
                <div class="detail">
                    <div class="desc-area wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision"
                             ...
                             fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 482 511.93">
            ...
            <div class="modal-footer">
                <button id="reservation-btn" type="button" class="btn btn-primary"
                        data-bs-toggle="modal" data-bs-target="#exampleModal1">예약하기
                </button>
